	...
	<body>
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
				...
				$type = mysqli_real_escape_string($db->link, $_POST['roomtype']);
				
                if($name==''||  $phone==''|| $address==''|| $type==''){
                    $error="Field must not be Empty !!";
                }else{
                    $query = "INSERT INTO booking(name,phone,address,type) Values('$name','$phone','$address','$type')";
				...
				<div class="mitext">
					<div class="tet1">
						...
						<form action="s.php" method="post">
							...
							<input type="text" name="roomtype" placeholder="Single-2rooms" required>
							<br>
							<br>
